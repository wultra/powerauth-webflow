...
package com.wultra.security.powerauth.lib.webflow.authentication.method.form.controller;

import com.wultra.core.rest.model.base.response.ObjectResponse;
import com.wultra.security.powerauth.lib.dataadapter.model.converter.UserAccountStatusConverter;
...
import com.wultra.security.powerauth.lib.dataadapter.model.enumeration.OperationTerminationReason;
...
import com.wultra.security.powerauth.lib.nextstep.model.entity.AfsActionDetail;
...
import com.wultra.security.powerauth.lib.nextstep.model.entity.enumeration.UserAccountStatus;
...
import com.wultra.security.powerauth.lib.nextstep.model.exception.UserNotFoundException;
import com.wultra.security.powerauth.lib.nextstep.model.response.*;
import com.wultra.security.powerauth.lib.webflow.authentication.configuration.WebFlowServicesConfiguration;
import com.wultra.security.powerauth.lib.webflow.authentication.controller.AuthMethodController;
import com.wultra.security.powerauth.lib.webflow.authentication.encryption.AesEncryptionPasswordProtection;
import com.wultra.security.powerauth.lib.webflow.authentication.encryption.NoPasswordProtection;
import com.wultra.security.powerauth.lib.webflow.authentication.encryption.PasswordProtection;
import com.wultra.security.powerauth.lib.webflow.authentication.exception.AuthStepException;
import com.wultra.security.powerauth.lib.webflow.authentication.exception.AuthenticationFailedException;
import com.wultra.security.powerauth.lib.webflow.authentication.exception.CommunicationFailedException;
import com.wultra.security.powerauth.lib.webflow.authentication.exception.MaxAttemptsExceededException;
import com.wultra.security.powerauth.lib.webflow.authentication.method.form.model.request.UsernamePasswordAuthRequest;
import com.wultra.security.powerauth.lib.webflow.authentication.method.form.model.request.UsernamePasswordInitRequest;
import com.wultra.security.powerauth.lib.webflow.authentication.method.form.model.response.UsernamePasswordAuthResponse;
import com.wultra.security.powerauth.lib.webflow.authentication.method.form.model.response.UsernamePasswordInitResponse;
import com.wultra.security.powerauth.lib.webflow.authentication.model.AuthResultDetail;
import com.wultra.security.powerauth.lib.webflow.authentication.model.OrganizationDetail;
import com.wultra.security.powerauth.lib.webflow.authentication.model.converter.AuthInstrumentConverter;
import com.wultra.security.powerauth.lib.webflow.authentication.model.converter.OrganizationConverter;
import com.wultra.security.powerauth.lib.webflow.authentication.service.AfsIntegrationService;
    ...
    protected AuthResultDetail authenticate(UsernamePasswordAuthRequest request) throws AuthStepException {
        ...
        try {
            ...
            if (authResponse.isOperationFailed()) {
                logger.info("Step authentication maximum attempts reached due to failed operation, operation ID: {}, authentication method: {}", operation.getOperationId(), getAuthMethodName().toString());
