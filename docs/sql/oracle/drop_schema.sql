...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE wf_certificate_verification';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE oauth2_authorization';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE oauth2_authorization_consent';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE oauth2_registered_client';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
