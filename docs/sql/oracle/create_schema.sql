...
CREATE TABLE oauth_code (
  code           VARCHAR2(255 CHAR),                          -- OAuth 2.0 protocol "codes".
  authentication BLOB                                         -- Encoded authentication details.
);
...
CREATE TABLE ns_credential_policy (
  ...
  status                     NUMBER(10,0) NOT NULL,                         -- Credential policy status: ACTIVE, REMOVED.
...
CREATE TABLE ns_otp_policy (
  ...
  status                 NUMBER(10,0) NOT NULL,                             -- One time password policy status: ACTIVE, REMOVED.
...
CREATE TABLE ns_hashing_config (
  ...
  status                   NUMBER(10,0) NOT NULL,                           -- Hashing configuration status: ACTIVE, REMOVED.
...
CREATE TABLE ns_credential_definition (
  ...
  description              VARCHAR2(255 CHAR),                              -- Description of the credential definition.
  ...
  category                 NUMBER(10,0) NOT NULL,                           -- Credential category: PASSWORD, PIN, OTHER.
...
CREATE TABLE ns_otp_definition (
  ...
  description              VARCHAR2(255 CHAR),                              -- Description of the one time password definition.
  application_id           NUMBER(19,0) NOT NULL,                           -- Application identifier.
...
CREATE TABLE ns_authentication (
  ...
  user_id                     VARCHAR2(255 CHAR),                           -- User identity identifier.
...
CREATE TABLE da_user_credentials (
  ...
  username              VARCHAR2(255 CHAR) NOT NULL,                      -- Username, the displayable value that users use to sign in.
  password_hash         VARCHAR2(255 CHAR) NOT NULL,                      -- Bcrypt hash of the password.
  family_name           VARCHAR2(255 CHAR) NOT NULL,                      -- User family name.
  given_name            VARCHAR2(255 CHAR) NOT NULL,                      -- User given name.
  organization_id       VARCHAR2(64 CHAR)  NOT NULL,                      -- User organization ID.
  phone_number          VARCHAR2(255 CHAR) NOT NULL                       -- Full phone number, should be stored in format that allows easy SMS message sending.
);
