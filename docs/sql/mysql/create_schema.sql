...
CREATE TABLE ns_credential_definition (
    ...
    category                 INTEGER,                                     -- Credential category: PASSWORD, PIN, OTHER.
...
CREATE TABLE ns_operation (
  ...
  FOREIGN KEY ns_operation_user_fk (user_id) REFERENCES ns_user_identity (user_id),
...
CREATE TABLE ns_user_prefs (
  ...
  FOREIGN KEY ns_user_prefs_fk (user_id) REFERENCES ns_user_identity (user_id)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
