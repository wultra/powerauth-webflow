...
package com.wultra.security.powerauth.app.nextstep.exception;
...
import com.wultra.security.powerauth.lib.nextstep.model.entity.error.Violation;
import com.wultra.security.powerauth.lib.nextstep.model.entity.error.response.CredentialValidationErrorResponse;
import com.wultra.security.powerauth.lib.nextstep.model.entity.error.response.ExtendedErrorResponse;
...
public class DefaultExceptionResolver {
    ...
    public @ResponseBody ErrorResponse handleDefaultException(Throwable t) {
        ...
        audit.error("Error occurred in Next Step server", AUDIT_DETAIL_UNEXPECTED_ERROR, t);
