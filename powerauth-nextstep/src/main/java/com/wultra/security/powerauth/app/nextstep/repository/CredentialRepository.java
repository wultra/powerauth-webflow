...
public interface CredentialRepository extends CrudRepository<CredentialEntity, String> {
    ...
    @Query("UPDATE CredentialEntity c SET " +
            "c.status = com.wultra.security.powerauth.lib.nextstep.model.entity.enumeration.CredentialStatus.ACTIVE, " +
            "c.failedAttemptCounterSoft = 0, " +
            "c.timestampBlocked = null " +
            "WHERE c.status = com.wultra.security.powerauth.lib.nextstep.model.entity.enumeration.CredentialStatus.BLOCKED_TEMPORARY")
    ...
    @Query("UPDATE CredentialEntity c SET " +
            "c.failedAttemptCounterSoft = 0 " +
            "WHERE c.status = com.wultra.security.powerauth.lib.nextstep.model.entity.enumeration.CredentialStatus.ACTIVE " +
