 ...
 */
package com.wultra.security.powerauth.app.nextstep.repository;

import com.wultra.security.powerauth.app.nextstep.repository.model.entity.OperationEntity;
import com.wultra.security.powerauth.app.nextstep.repository.model.entity.OtpEntity;
...
public interface OtpRepository extends CrudRepository<OtpEntity, String> {
     ...
     */
    @Modifying
    @Query("UPDATE OtpEntity o SET o.status = com.wultra.security.powerauth.lib.nextstep.model.entity.enumeration.OtpStatus.REMOVED " +
            "WHERE o.userId = ?1 " +
            "AND o.status <> com.wultra.security.powerauth.lib.nextstep.model.entity.enumeration.OtpStatus.REMOVED")
