...
package io.getlime.security.powerauth.lib.bankadapter.exception;
...
public class DefaultExceptionResolver {
    ...
    public @ResponseBody ErrorResponse handleDefaultException(Throwable t) {
        Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "Error occurred in Bank Adapter", t);
        BankAdapterError error = new BankAdapterError(BankAdapterError.Code.ERROR_GENERIC, "Unknown Error");
    ...
    public @ResponseBody ErrorResponse handleAuthenticationError(AuthenticationFailedException ex) {
        ...
        BankAdapterError error = new BankAdapterError(BankAdapterError.Code.AUTHENTICATION_FAILED, ex.getMessage());
        return new ErrorResponse(error);
    }
    ...
    public @ResponseBody ErrorResponse handleDefaultException(MethodArgumentNotValidException ex) {
        ...
        BankAdapterError error = new BankAdapterError(BankAdapterError.Code.INPUT_INVALID, message);
